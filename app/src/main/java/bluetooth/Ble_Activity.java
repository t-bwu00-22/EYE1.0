...
import com.example.eye20.DataFile;
import com.example.eye20.DisPlay;
import com.example.eye20.MainActivity;
...
public class Ble_Activity extends Activity implements View.OnClickListener{
    ...
    public String HEART_RATE_MEASUREMENT = DisPlay.readFileData_1("Device_uuid",Ble_Activity.this);
